...
// "Родина" проекта на http://vga-avr.narod.ru/
/*
...
const char str1[] PROGMEM =   "Minibits terminal PAL serial @19200bps";
const char str2[] PROGMEM =   "Minibits teminal VGA";
const char str3[] PROGMEM =   "serial @19200 bps";
